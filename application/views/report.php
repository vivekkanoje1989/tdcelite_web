...
function approve_task_data(){
    ...
    $.ajax({
            type: "GET",
            url: '<?php echo base_url();?>index.php/tdcelite/approve_employee_task_report?project_id= '+project_id+' &emp_id= '+emp_id+' &reportrange= '+reportrange+' ',
            success: function(data){
               ...
               toastr.info('Showing Tasks done by selected Employee.', 'Information', {timeOut: 5000});
                //alert("data:" + data);    
